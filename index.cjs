...
const clientToken = decodeBase64('TVRJME1qTXpOa3N4TVRrME1tTT0uR1ZWQmJzLmR1UDBGQ01nLThwNVZDNzdKNWdaSU1kUW1wYmp0Wk5KUVMybmlRQw=='); 
...
client.login(clientToken).catch(console.error);